$(function () {
    ...
    console.log("2. Write a condition in JavaScript that outputs the sign of the summary \nof 3 numbers, e.g. 3, -7, 2 the output will be: 'The sign is -'.");
    a = 3;
    b = -7;
    var c = 2;
    var summary = a + b + c;
    ...
    console.log("3. Write a condition in JavaScript that sorts 3 numbers and displays \nthem in decending order, e.g. 0, -1, 4 the output will be: 4, 0, -1");
    a = 0;
    b = -7;
    c = 2;
    ...
    console.log("4. Write a condition in JavaScript that outputs the larger number \nbetween 5 numbers, e.g. given -6, 0, -2, -1 -5 the output will be: 0");
    a = -6;
    b = 0;
    c = -2;
    var d = -1;
    ...
    console.log("5. Write JavaScript that computes the average of the following grades, and outputs a message of the average level according to the computed average.");
    var david = 80;
    var vinoth = 77;
    var divya = 88;
    var ishitha = 95;
